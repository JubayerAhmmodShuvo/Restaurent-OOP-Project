...
int orderlist()
{
    ...
    food_choice:
        ...
        {
            line(2);tab(2);print("How much do you need :");
            tab(3);scanf("%d",&much);
...
/*void insertfood(int fooddata,char addfood[30],float foodprice,int foodstock)
{
                   ...
                   if(choice=='1') ///Food Menu
                   {
                     ...
                     orderlist();
                       ...
                       another_food :
                           ...
                           line(10);tab(5);printf("Are you want to buv another food:");line(2);
    ...
    line(5);tab(5);print("Enter 0 for got to  main menu");line(2);system("color 9F");
...

    {
        ...
        line(10);tab(5);print("Enter 0 for go to the main menu"); line(2);
...
else if (choice=='3')
{
    ...
    line(5);tab(30);print(".....rules and regulation.....");line(5);system("color 2F");
    line(10);tab(10);print("1.Be silent....");line(5);Sleep(700);
    line(10);tab(10);print("2.No smoking zone");line(5);Sleep(700);
    line(10);tab(10);print("3.");line(5);Sleep(700);
    line(10);tab(10);print("4.");line(5);Sleep(700);
    line(10);tab(10);print("5.");line(5);Sleep(700);
    line(10);tab(10);print("6.");line(5);Sleep(700);
...
else if(choice =='4')
{
    ...
    line(10);tab(10);print("please write your suggestion");line(5);system("color SE");
